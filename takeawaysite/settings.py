"""
Django settings for takeawaysite project.
...
ROOT_URLCONF = 'takeawaysite.urls'
...
WSGI_APPLICATION = 'takeawaysite.wsgi.application'
...
# Email configuration
# for gmail smtp.gmail.com ; for abv is smtp.abv.bg
# for gmail is 587, for abv is 465
EMAIL_HOST = config('EMAIL_HOST')
EMAIL_PORT = config('EMAIL_PORT', cast=int)
EMAIL_HOST_USER = config('EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = 'epog twdb objl hahv'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'foodOnline Marketplace <daniela.krmv@gmail.com>'

GOOGLE_API_KEY = 'AIzaSyAeVbua9AyuRo56ocnwog-cyRwg1Rqcngg'
